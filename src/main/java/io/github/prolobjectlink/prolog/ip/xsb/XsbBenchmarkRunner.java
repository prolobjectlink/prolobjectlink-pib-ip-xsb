 ...
 * #L%
 */
package io.github.prolobjectlink.prolog.ip.xsb;
...
public class XsbBenchmarkRunner extends AbstractBenchmarkRunner implements BenchmarkRunner {
	...
	public static class ExecutionPlan {
		...
		public void setUp() {
			...
			provider = Prolog.getProvider(XsbProlog.class);
...
//                  D is ( P * 100 ) / A.
	...
	public static void main(String[] args) throws RunnerException {
		...
		builder.include(XsbBenchmarkRunner.class.getSimpleName());
		Options opt = builder.build();
		Collection<RunResult> run = new Runner(opt).run();
		new XsbBenchmarkRunner().output(run);
